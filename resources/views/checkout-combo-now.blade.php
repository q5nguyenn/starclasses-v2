        ...
        @foreach ($courses as $course)
          <a class="course-profile-item" href="{{ route('course', ['slug' => $course->slug]) }}">
            ...
            <div class="course-profile-wrapper">
              ...
              <div class="course-profile-delele" hidden>
    ...
    <div class="pay-wrapper">
      ...
      <div class="pay-item pay-payment">
        ...
        <div style="margin-left: 20px; text-align: right">
          <div class="pay-total-price-sale">{{ $combo->price }} $</div>
          <div class="pay-total-price-old">{{ $combo->primaryPrice() }} $</div>
          <div class="pay-total-price-percent">{{ $combo->discountPercent() }}%</div>
        </div>
      </div>
      <div style="text-align: right; margin-top: 10px">
        ...
        <button class="button" id="finish-pay" data-url={{ route('checkout.combo.payment.now') }}>Complete
          payment</button>
      </div>
      <div class="print">
...
@section('js')
  ...
  <script type="module" src="{{ asset('js/checkout-combo-now.js') }}"></script>
