@php
  ...
  if ($totalPrice == 0) {
      ...
      $discountPercent = round((($totalPrice - $totalDiscount) / $totalPrice) * 100);
  }
    ...
    <div class="pay-wrapper">
      ...
      <div class="pay-item pay-payment">
        ...
        <div style="margin-left: 20px; text-align: right">
          <div class="pay-total-price-sale">{{ $totalDiscount }} $</div>
          <div class="pay-total-price-old">{{ $totalPrice }} $</div>
          <div class="pay-total-price-percent">{{ $discountPercent }}%</div>
        </div>
      </div>
      <div style="text-align: right; margin-top: 10px">
        ...
        <button class="button" id="finish-pay" data-url={{ route('checkout.payment') }}>Complete payment</button>
      </div>
      <div class="print">
