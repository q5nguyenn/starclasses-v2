  ...
  <div class="search-result">
    <div class="profile-frame" data-frame="2">
      <div class="profile-frame-top my-3">
        <div class="profile-frame-title">ADD COMBO</div>
      </div>
      <div class="profile-frame-wrapper">
        <form class="profile-frame show" novalidate method="post" action="{{ route('admin.combo.store') }}">
          @csrf
          ...
          <div class="profile-frame-wrapper">
            <div class="input-item">
              ...
              <textarea id="problem_solving" name="problem_solving" class="form-control" rows="3" required>{{ old('problem_solving') }}</textarea>
            ...
            <div class="input-item">
              ...
              <textarea id="introduce" name="introduce" class="form-control" rows="3" required>{{ old('introduce') }}</textarea>
              <div class="invalid-tooltip">This field is required</div>
              <div class="input-item-error">&nbsp;
                @error('introduce')
                  {{ $message }}
