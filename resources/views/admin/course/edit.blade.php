  ...
  <div class="search-result">
    <div class="profile-frame" data-frame="2">
      <div class="profile-frame-top my-3">
        <div class="profile-frame-title">UPDATE COURSE</div>
      </div>
      <div class="profile-frame-wrapper">
        <form class="profile-frame show" data-frame="0" enctype="multipart/form-data"
          action="{{ route('admin.course.update', ['id' => $course->id]) }}" method="post">
          @csrf
          <div class="profile-frame-wrapper profile-frame-flex profile-frame-flex-mobile profile-frame-flex-gap">
            <div class="profile-frame-column">
              ...
              <input type="file" id="choose-avatar" accept="image/*" name="thumbnail" />
              ...
              <div class="input-item input-item-bottom">
                <textarea name="description" id="description" class="input" style="height:150px">{{ old('descripton', $course->description) }}</textarea>
            ...
            <div class="profile-frame-column">
              ...
              <div class="input-item input-item-bottom">
                <input type="number" class="input" id="discount" name="discount"
              ...
              <select class="form-control js-example-tokenizer" multiple="multiple" name="tags[]" id="tags">
                @foreach ($listTags as $tag)
                  <option value="{{ $tag->id }}" {{ in_array($tag->id, old('tags', $tagIds)) ? 'selected' : '' }}>
                    {{ $tag->name }}</option>
                @endforeach
              </select>
              <div class="input-item-error">&nbsp;
          ...
          <div class="profile-frame-wrapper">
            <div class="input-item">
              ...
              <textarea id="learn" name="learn" class="form-control" rows="3" required>
								{{ old('learn', $course->learn) }}
							</textarea>
            ...
            <div class="input-item">
              ...
              <textarea id="introduction" name="introduction" class="form-control" rows="3" required>
								{{ old('introduction', $course->introduction) }}
							</textarea>
              <div class="invalid-tooltip">This field is required</div>
              <div class="input-item-error">&nbsp;
                @error('introduction')
          ...
          <button class="button-fa flex-right btn-update-user" id="btn-update" type="submit">Update</button>
        </form>
      </div>
